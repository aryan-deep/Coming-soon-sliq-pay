const Footer = () => (
  <footer className="bg-black text-gray-200 py-[80px] px-6 md:px-[72px]">
    <div className="flex flex-col md:flex-row justify-between gap-[40px] md:gap-[100px]" style={{ fontFamily: 'nunito' }}>
      ...
      <div className="flex flex-col md:flex-row items-start md:items-end flex-1 w-full">
        ...
        <div className="flex flex-col justify-between h-full w-full md:w-auto">
          <div>
            <h3 className="font-semibold mb-2 text-left">Contact Us</h3>
            <p className="text-sm break-words text-left">support@arksventures.ai</p>
          </div>
          <div>
            <h3 className="font-semibold mt-[50px] mb-2 text-left">Location</h3>
            <p className="text-sm text-left">ARKS Ventures LLC</p>
            <p className="text-sm text-left">765 W Middlefield Rd, Unit 2203</p>
            <p className="text-sm text-left">Mountain View, CA 94043 US</p>
            <p className="mt-[50px] text-xs text-left">NMLS ID: 2714589<br />MSB Registration Number: 31000298221871</p>
          </div>
        </div>
